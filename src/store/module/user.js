...
export default {
  state: {
    ...
    token: getToken(),
    access: '',
    hasGetInfo: window.sessionStorage.getItem('hasGetInfo') == null ? false : true,
    unreadCount: 0,
    messageUnreadList: [],
    messageReadedList: [],
    messageTrashList: [],
  ...
  actions: {
    ...
    handleLogOut ({ state, commit }) {
      return new Promise((resolve, reject) => {
        ...
        window.sessionStorage.removeItem('hasGetInfo')
    ...
    getUserInfo ({ state, commit }) {
      return new Promise((resolve, reject) => {
        try {
          console.log("getUserInfo, token=", state.token)
